...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "the-go-server";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "74065814646";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "74065814646-53pj6vvq6u2dnampea4o57s3l7i3pcs3.apps.googleusercontent.com";
